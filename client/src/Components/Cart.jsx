                ...
                <table className='table'>
                    <tbody>
                        ...
                        </tr>
                        {
                            cart.map((item, index) => {
                                return <tr key={index}>
                                    <td><img src={`./public/uploads/${item.pic}`} width="100px" height="70px" className="rounded" /></td>
                                    <td>{item.name}</td>
                                    ...
                                    <td>{item.qty}</td>
                                    <td><button className='btn mybtn text-danger' onClick={() => updateRecord(item._id, "INC")}><AddIcon /></button></td>
