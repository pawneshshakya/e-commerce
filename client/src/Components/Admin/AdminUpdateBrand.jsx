...
export default function AdminUpdateBrand() {
    ...
    var { getSingle, update } = useContext(Brand)
                ...
                <div className='col-lg-10 col-md-8 col-sm-6 col-12'>
                    ...
                    <form onSubmit={postData}>
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control" name="name" onChange={getData} required placeholder='Enter Brand Name : ' value={name} />
                        </div>
